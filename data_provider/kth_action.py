...
class DataProcess(object):
  ...
  def __init__(self, input_param):
    ...
    # self.category = ['boxing', 'handclapping']
    self.image_width = input_param['image_width']
  ...
  def load_data(self, paths, mode='train'):
    ...
    for c_dir in c_dir_list:  # handwaving
      ...
      print("c_dir_path:{}".format(c_dir_path))
      p_c_dir_list = os.listdir(c_dir_path)
      # p_c_dir_list.sort() # for date seq
      print("len of {} : {}".format(c_dir_path, len(p_c_dir_list)))
    ...
    print("len of frames_np:{}".format(len(frames_np)))
    ...
    print("indices.example:{}".format(indices[:5]))
    return data, indices
